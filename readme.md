...
<a id="printDensityDef"></a> <!-- a tag is placed to enable linking -->
...
<a id="printerStatus"></a> <!-- a tag is placed to enable linking -->
<br/>
...
<a id="cursorPosition"></a> <!-- a tag is placed to enable linking -->
<br/>
### int cursorPosition()  
Returns the position of the cursor .


<a id="setCursorPosition"></a> <!-- a tag is placed to enable linking -->
<br/>
...
<a id="setFontFace"></a> <!-- a tag is placed to enable linking -->
<br/>
...
<a id="setFontSize"></a> <!-- a tag is placed to enable linking -->
<br/>
...
<a id="addTextToLine"></a> <!-- a tag is placed to enable linking -->
<br/>
...
<a id="printLine"></a> <!-- a tag is placed to enable linking -->
<br/>
### void printLine()  
Prints buffer for current line.
    
<a id="drawLine"></a> <!-- a tag is placed to enable linking -->
<br/>
...
<a id="printText"></a> <!-- a tag is placed to enable linking -->
<br/>
...
<a id="printBitmap"></a> <!-- a tag is placed to enable linking -->
<br/>
...
<a id="addSpace"></a> <!-- a tag is placed to enable linking -->
<br/>
...
<a id="addEmptyLines"></a> <!-- a tag is placed to enable linking -->
<br/>
...
<a id="lineSpacing"></a> <!-- a tag is placed to enable linking -->
<br/>
### float lineSpacing()  
Gets line spacing.

<a id="setLineSpacing"></a> <!-- a tag is placed to enable linking -->
<br/>
### void setLineSpacing(float f)  
Sets line spacing.

<a id="printDensity"></a> <!-- a tag is placed to enable linking -->
<br/>
### int printDensity()  
Returns current print density.  
See [definition of print density.](#printDensityDef)

<a id="setPrintDensity"></a> <!-- a tag is placed to enable linking -->
<br/>
